...
public interface AttendanceRepository extends JpaRepository<AttendanceRecords,Integer>{
	...
	@Query("SELECT  a.employeeId,a.clockInTime, a.clockOutTime, a.workHours, a.status , a.date FROM AttendanceRecords a WHERE a.date BETWEEN :startDate AND :endDate")
